...
defmodule MetricsAssertions do
  ...
  def assert_metric_reported(metric_type, metric_name, expected_metric_value) do
    ...
    case expected_metric_value do
      _.._ -> do_assert_range(expected_metric_value, actual_value)
      _ -> assert expected_metric_value == actual_value
    end
  end
  ...
  def assert_metric_reported(metric_type, metric_name, expected_metric_value, options) do
    ...
    case expected_metric_value do
      _.._ -> do_assert_range(expected_metric_value, actual_metric_value)
      _ -> assert expected_metric_value == actual_metric_value
    end
  end
